...
export const UpdateHostConfiguration = function (payload: any, host_id: string) {
...
export const UpdateRouterConfiguration = function (payload: any, router_id: string) {
    // Reset network player
    SetNetworkPlayerState(-1);
...
export const UpdateServerConfiguration = function (payload: any, router_id: string) {
    // Reset network player
    SetNetworkPlayerState(-1);
...
export const UpdateHubConfiguration = function (payload: any, hub_id: string) {
    ajaxWithAuth({
        type: "POST",
...
export const UpdateSwitchConfiguration = function (payload: any, switch_id: string) {
    // Reset network player
    SetNetworkPlayerState(-1);
